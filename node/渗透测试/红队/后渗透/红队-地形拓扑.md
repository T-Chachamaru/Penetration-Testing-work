...
#### 目录
- [网络结构与分段理解](#二-网络结构与分段理解-understanding-network-structure--segmentation)
- [基础网络环境枚举](#三-基础网络环境枚举-basic-network-environment-enumeration)
- [活动目录 (AD) 环境探查](#四-活动目录-ad-环境探查-active-directory-environment-reconnaissance)
- [主机安全解决方案识别](#五-主机安全解决方案识别-identifying-host-based-security-solutions)
- [网络安全解决方案识别](#六-网络安全解决方案识别-identifying-network-based-security-solutions)
- [应用与服务探查](#七-应用与服务探查-application-and-service-reconnaissance)
