...
- [核心组件与部署](#核心组件与部署)
- [基本工作流程](#基本工作流程)
- [C2 通信与隐蔽性](#c2-通信与隐蔽性-beaconing--evasion)
- [主要功能与模块](#主要功能与模块)
- [扩展性](#扩展性-extensibility)
- [免杀与加载器](#免杀与加载器-evasion--loaders)
- [C2 基础设施与操作安全](#c2-基础设施与操作安全-opsec)
- [C2 重定向器与可塑性](#c2-重定向器与可塑性-redirectors--malleable-c2)
- [常见的 C2 框架](#常见的-c2-框架)
