...
#### 目录
- [混淆在静态规避中的作用](#混淆在静态规避中的作用-role-of-obfuscation-in-static-evasion)
- [混淆在分析对抗中的作用](#混淆在分析对抗中的作用-deceptive-functions-of-obfuscation-in-anti-analysis)
- [保护和剥离可识别信息](#保护和剥离可识别信息-protecting-and-stripping-identifiable-information)
