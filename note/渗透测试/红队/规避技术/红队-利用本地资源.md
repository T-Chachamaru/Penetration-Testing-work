...
#### 目录
- [系统内部工具](#系统内部工具-system-internals-tools---windows-sysinternals)
- [LOLBAS 项目](#lolbas-项目-the-lolbas-project)
- [文件操作：利用原生工具进行数据交互](#文件操作利用原生工具进行数据交互-file-operations-using-native-tools-for-data-interaction)
- [文件执行：利用原生工具进行代理执行](#文件执行利用原生工具进行代理执行-file-execution-using-native-tools-for-proxy-execution)
- [应用程序白名单绕过](#应用程序白名单绕过-application-whitelisting-bypass)
- [其他“就地取材”技术](#其他就地取材技术-other-living-off-the-land-techniques)
